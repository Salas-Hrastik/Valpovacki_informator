 ...
 * stvarnoj relevantnosti za pitanje. Ključno kad u knjizi ima mnogo SLIČNIH
 * odjeljaka (npr. više poglavlja spominje "motivaciju") pa vektor/FTS izvuku
 * pravi tip sadržaja, ali ne i baš onaj odjeljak koji sadrži odgovor.
 *
    ...
    const msg = await anthropic.messages.create(
      {
        ...
        max_tokens: 80,
        system:
          'Ti odabireš dijelove knjige za odgovor na pitanje korisnika. Na temelju pitanja vrati ' +
